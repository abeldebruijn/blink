...
const hooks = {
  sandbox: {
    onSandboxReady: [
      { command: "pnpm install --frozen-lockfile", timeoutMs: 300_000 },
    ],
  },
};

// Do not copy node_modules into each worktree: this repo's dependency tree is
// large enough to exceed Sandcastle's host-side copy timeout. The hook above
// installs dependencies inside each sandbox instead.
